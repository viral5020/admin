...
import Bulktrading from './Utility/Bulktrading';
import Autosquareuplog from './Autosquareuplog';
import Autosquareuplogcard from './Autosquareuplogcard';
import Mtmalerts from './Mtmalerts';
...
function Masterdashboard() {
    ...
    const initialMasterData = [
        {
            ...
            abbr: "MA",
            companies: [
                { name: "Company 1", qty: 200, price: 50, pl: 5000 },
                { name: "Company 2", qty: 300, price: 60, pl: -2000 },
            ],
        },
        {
            name: "Master B",
            ...
            abbr: "MB",
            companies: [
                { name: "Company 3", qty: 150, price: 70, pl: 3000 },
                { name: "Company 4", qty: 150, price: 80, pl: -1000 },
            ],
        },
    ];
    ...
    const quickLinks = [
        {
            ...
            desc: "View overall stats and metrics",
            url: "/app/dashboard/summary-report",
        },
        {
            title: "User Edit Log",
            desc: "Track user profile updates",
            url: "/app/dashboard/user-edit-log",
        },
        {
            title: "Trade Edit/Delete Log",
            desc: "Review trade changes and deletions",
            url: "/app/dashboard/trade-edit-delete-log",
        },
        {
            title: "Cash Edit/Delete Log",
            desc: "Review trade changes and deletions",
            url: "/trade-edit-delete-log",
        },
    ];
    ...
    const fetchOrders = async (type = "today", searchValue = "") => {
        setLoading(true);
        const result = await fetchOrdersAPI({ filterType: type, searchValue });
    ...
    return (
        <Box sx={{ px: { xs: 2, md: 5 }, py: 1 }}>
            ...
            <Grid container spacing={1}>
                        ...
                        <InfoCardHorizontal
                            ...
                            content={[
                                <Box sx={{ display: "flex", gap: 1 }}>
                                    <span
                                        onClick={() => handleOpen4("client")}
                                        style={{ cursor: "pointer", color: "#000000ff" }}
                                    >
                                        Client
                                    </span>
                                    <span
                                        onClick={() => handleOpen4("master")}
                                        style={{ cursor: "pointer", color: "#000000ff" }}
                                    >
                                        Master
                                    </span>
                                    <span
                                        onClick={() => handleOpen4("broker")}
                                        style={{ cursor: "pointer", color: "#000000ff" }}
                                    >
                                        Broker
                                    </span>
                ...
                >
                    <DialogTitle sx={{ p: 1, mb: 0 }}>Client Info</DialogTitle> {/* mb:0 removes bottom margin */}
                    <DialogContent sx={{ p: 0, '&:first-child': { pt: 0 } }}>
                        {/* p:0 removes padding; &:first-child ensures no top padding */}
                        <Userlisting filterShow={false} />
                    </DialogContent>
                ...
                <Dialog
                    open={openDialog4 === "master"}
                    onClose={handleClose4}
                    maxWidth="xl"
                    fullWidth
                    PaperProps={{
                        sx: { m: 0, width: "95%", maxHeight: "95vh" },
                    }}
                >
                    <DialogTitle sx={{ p: 1 }}>Master Info</DialogTitle>
                    <DialogContent sx={{ p: 0 }}>
                        <Masterlisting filterShow={false} />
                    </DialogContent>
                    <DialogActions sx={{ p: 1 }}>
                        <Button onClick={handleClose4}>Close</Button>
                    </DialogActions>
                ...
                >
                    <DialogTitle sx={{ p: 1 }}>Broker Info</DialogTitle>
                    <DialogContent sx={{ p: 0 }}>
                        <BrokerListing filterShow={false} />
                    </DialogContent>
                    <DialogActions sx={{ p: 1 }}>
                        <Button onClick={handleClose4}>Close</Button>
                    </DialogActions>
                ...
                <Grid item xs={12} md={6}>
                    <Paper
                        elevation={3} // slight shadow for card look
                        sx={{
                            ...glassStyles,
                            height: 400,
                            display: 'flex',
                    ...
                    >
                        {/* Title */}
                        <Typography variant="subtitle1" fontWeight={700} textAlign="left" mb={1}>
                            MTM Alerts
                        </Typography>
                        <Divider sx={{ mb: 1 }} />
                ...
                <Grid item xs={12} md={6} sx={{ px: 0 }}>
                    ...
                    >
                        ...
                        >
                            <Autosquareuplogcard filterShow={false} />
                        </Box>
                    </Paper>
                </Grid>
                        ...
                        <Box sx={{ height: 220, m: 0, p: 0 }}>
                            <Doughnut
                                ...
                                data={{
                                    ...
                                    datasets: [
                                        {
                                            data: masterData.map((m) => m.totalQty),
                                            backgroundColor: masterData.map((_, i) =>
                                ...
                                options={{
                                    ...
                                    onClick: (event, elements) => {
                                        if (elements?.length > 0) {
                                            const index = elements[0].index;
                                            setSelectedMaster(masterData[index]);
                                            setOpenMaster(true);
                                        }
                                    },
                                    plugins: {
                                        tooltip: {
                                            callbacks: {
                                                label: function (context) {
                                                    ...
                                                    return `Total Qty: ${master.totalQty}`;
                                                },
                                            },
                                        },
                                        legend: {
                ...
                <Dialog open={openMaster} onClose={() => setOpenMaster(false)} fullWidth maxWidth="md">
                    ...
                    >
                        <DialogTitle sx={{ m: 0, p: 0, fontWeight: 600, fontSize: { xs: "1.1rem", sm: "1.3rem" } }}>
                            {selectedMaster?.name} Master Details
                        </DialogTitle>
                        <Typography variant="subtitle1" fontWeight={600} sx={{ fontSize: { xs: "0.95rem", sm: "1.05rem" }, color: "text.secondary" }}>
                            Total Qty: {selectedMaster?.totalQty}
                        </Typography>
                    </Box>

                    <DialogContent sx={{ overflow: "hidden", px: { xs: 2, sm: 3 } }}>
                        {selectedMaster?.companies?.length > 0 && (
                            <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, gap: 4, alignItems: "stretch" }}>
                                {/* Chart */}
                                <Box sx={{ flex: 1, width: "100%", maxWidth: { xs: "100%", md: 400 }, height: { xs: 250, sm: 300 }, mx: "auto" }}>
                                    <Pie
                                        data={{
                                            labels: selectedMaster.companies.map((c) => c.name),
                                            datasets: [
                                                {
                                                    data: selectedMaster.companies.map((c) => c.qty),
                                                    backgroundColor: selectedMaster.companies.map((_, i) =>
                                                        ["#42a5f5", "#66bb6a", "#ffca28", "#ef5350", "#ab47bc", "#26c6da"][i % 6]
                                                    ),
                                                    borderColor: theme.palette?.mode === "dark" ? "#444" : "#fff",
                                                },
                                        ...
                                        options={{
                                            ...
                                            maintainAspectRatio: false,
                                            plugins: {
                                                legend: { position: "bottom", labels: { usePointStyle: true, color: theme.palette?.text?.primary } },
                                                tooltip: {
                                                    callbacks: {
                                                        label: function (context) {
                                                            const index = context.dataIndex;
                                                            const company = selectedMaster.companies[index];
                                                            return `${company.name}\nQty: ${company.qty}\nP/L: ₹${company.pl.toLocaleString("en-IN")}`;
                                                        },
                                                    },
                                                },
                                ...
                                >
                                    {selectedMaster.companies.map((company, i) => (
                                        <Box key={i} sx={{ mb: 2, p: 2, borderRadius: 2, backgroundColor: "background.paper", boxShadow: 1 }}>
                                            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" }}>
                                                <Typography fontWeight={600} variant="subtitle1">
                                                    {company.name}
                                                </Typography>
                                                <Typography variant="body2" sx={{ color: company.pl >= 0 ? "success.main" : "error.main", fontWeight: 600 }}>
                                                    P/L: ₹{company.pl}
                                                </Typography>
                                            </Box>
                    ...
                    <DialogActions sx={{ px: 3, pb: 2 }}>
                        <Button onClick={() => setOpenMaster(false)} variant="contained" color="secondary">
                            Close
                        </Button>
                    </DialogActions>
                </Dialog>
            ...
            <Grid container spacing={1} sx={{ pt: 3, alignItems: 'flex-start' }}>
                ...
                >
                    <DialogTitle sx={{ m: 0, p: 1 }}>Bulk Trading</DialogTitle>

                    <DialogContent dividers sx={{ m: 0, p: 0 }}>
                        <Bulktrading filterShow={false} />
                    </DialogContent>
                            ...
                            <Box sx={{ p: 0, m: 0 }}>
                                {!isMobile ? (
                                    <Box sx={{ display: 'flex', alignItems: 'center', p: 0, m: 0 }}>
                                        <Typography variant="subtitle1" fontWeight={700} textAlign="center" sx={{ m: 0, p: 0, lineHeight: 1 }}>
                                            Cash Entry
                                        </Typography>
                                    </Box>
                                ) : (
                                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 0, m: 0 }}>
                                        <Typography variant="subtitle1" fontWeight={700} textAlign="left" sx={{ m: 0, p: 0, lineHeight: 1 }}>
                                            Cash Entry
                                        </Typography>
                                    </Box>
                                )}
                                ...
                                loginData.map((login, idx) => (
                                    ...
                                    >
                                        ...
                                        <Box display="flex" alignItems="center" gap={1}>
                                            ...
                                            />
                                            <Box>
                                                <Typography variant="body2" fontWeight={500} sx={{ lineHeight: 1.2, m: 0 }}>
                                                    {login.loginTime}
                                                </Typography>
                                                <Typography variant="caption" color="text.secondary" sx={{ lineHeight: 1.2, m: 0 }}>
                                                    IP: {login.ip}
                                                </Typography>
                                            </Box>
                                        </Box>
