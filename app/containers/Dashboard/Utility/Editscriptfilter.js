...
const Editscriptfilter = ({
    ...
    const handleEdit = async () => {
        ...
        if (!newScriptName) {
            toast.warning('Please enter a new script name.', {
                position: 'top-right',
                autoClose: 3000,
            });
            return;
        ...
        console.log('Edit Script Payload:', payload);
        ...
        try {
            ...
            if (response.data.success) {
                ...
                toast.error('Failed to update script name. Please try again.', {
                    position: 'top-right',
                    autoClose: 3000,
                });
            }
            ...
            toast.error('An error occurred while updating script name.', {
                position: 'top-right',
                autoClose: 3000,
            });
        }
