...
function Application(props) {
  ...
  function isHave(keyWord) {
    if (!isEmployeeLogin || (userType == 4 && isEmployeeLogin && emp_permission?.includes(keyWord))) {
      return true;
    } else {
      return false;
    }
    ...
    <Dashboard history={history} changeMode={changeMode}>
      <Routes>
        <Route element={<ProtectedRoute />}>
          ...
          {/* ----------- Stock Trading ----------- */}
          <Route element={isHave('TRADE') ? <Outlet /> : <Navigate to="/app" />}>
            <Route
            ...
            <Route
              ...
              element={isStock ? <Positions /> : <Navigate to="/app" />}
            />
            <Route
            ...
            <Route
              ...
              element={userType === 4 ? <Manualtrade /> : <Navigate to="/app" />}
            />
            <Route
            ...
            />
            <Route
              path="dashboard/Self-P&L"
              element={userType === 4 ? <Selfpl /> : <Navigate to="/app" />}
            />
            <Route
          ...
          <Route element={isHave('TRADE') ? <Outlet /> : <Navigate to="/app" />}>
            <Route
              ...
              element={isForex ? <Watchlist /> : <Navigate to="/app" />}
            />
            <Route
            ...
            <Route
              ...
              element={isForex ? <Forex_position /> : <Navigate to="/app" />}
            />
            <Route
          ...
          {/* ----------- User Management ----------- */}
          <Route element={isHave('USERS') ? <Outlet /> : <Navigate to="/app" />}>
            ...
            <Route
              ...
              element={
                userType === 4 ? <Employeelisting /> : <Navigate to="/app" />
              }
            />
            <Route
              path="dashboard/add-employee"
              element={userType === 4 ? <Addemployee /> : <Navigate to="/app" />}
            />
          </Route>

          {/* ----------- Utility ----------- */}
          <Route element={isHave('UTILITY') ? <Outlet /> : <Navigate to="/app" />}>
            <Route
          ...
          <Route
            ...
            element={
              userType !== 2 && userType !== 1 ? <JV /> : <Navigate to="/app" />
            }
          />
          <Route
          ...
          <Route element={isHave('SETTING') ? <Outlet /> : <Navigate to="/app" />}>
            ...
            <Route
              ...
              element={
                userType === 3 ? <Masterqtysetting /> : <Navigate to="/app" />
              }
            />
            <Route
              path="dashboard/Script-Wise-Lot-setting"
              element={
                userType !== 3 ? <Scriptwiselot /> : <Navigate to="/app" />
              }
            />
            <Route
              path="dashboard/Add-Script"
              element={userType !== 3 ? <Addscript /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/Add-Expiry"
              element={userType !== 3 ? <Addepiry /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/Edit-Expiry"
              element={userType !== 3 ? <Editexpiry /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/Edit-Script"
              element={userType !== 3 ? <Editscript /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/CNBD-Awaaz"
              element={userType !== 3 ? <Cnbdawaz /> : <Navigate to="/app" />}
            />
            <Route
            ...
            <Route
              ...
              element={
                userType !== 3 ? <Nseoptmanagement /> : <Navigate to="/app" />
              }
            />
            <Route
              path="dashboard/MARQUEE"
              element={userType === 4 ? <Marquee /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/Expiry-Validation"
              element={
                userType !== 3 ? <Expiryvalidation /> : <Navigate to="/app" />
              }
            />
            <Route
            ...
            <Route
              ...
              element={userType !== 3 ? <Timesetting /> : <Navigate to="/app" />}
            />
            <Route
              path="dashboard/level-import"
              element={userType !== 3 ? <Levelimport /> : <Navigate to="/app" />}
            />
            <Route path="dashboard/banned-scripts" element={<BlockedScripts />} />
            <Route
              path="dashboard/max-qty-details"
              element={
                userType !== 2 && userType !== 4 && userType !== 5 && isStock ? (
                  <MaxQTYDetails />
                ) : (
                  <Navigate to="/app" />
                )
