...
const MobileStockTableDesign2 = ({ searchText, isStockOpen, setIsStockOpen, watchList, isDarkMode, onToggleFavorite, favorites }) => {
    ...
    function setSpace() {
        ...
        window.innerWidth < 360 ? setIsSmallMobile(true) : setIsSmallMobile(false);
    }
                ...
                return (
                    <React.Fragment key={stock.id}>
                        ...
                        >
                            ...
                            >
                                Q : {stock.qty.toLocaleString('en-IN')}
                            </Typography>
                            ...
                            <Stack
                                ...
                                <Typography
                                    variant="subtitle2"
                                    fontWeight={600}
                                    sx={{ color: textColor, lineHeight: '1rem', width: '22vw' }}
                                >
                            ...
                            {/** 2nd column */}
                            <Stack direction='row' gap={isSmallMobile ? 0 :'2vw'}
                                sx={{
                                    position: 'absolute',
                                    right: '4px',
                                    top: '0rem',
...
export default MobileStockTableDesign2;
