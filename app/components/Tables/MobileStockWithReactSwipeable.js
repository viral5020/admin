...
const MobileStockWithReactSwipeable = ({ searchText, isStockOpen, setIsStockOpen, dummyData, isDarkMode, onToggleFavorite, favorites, setDummyData }) => {
    ...
    const handlers = (index) => useSwipeable({
        onSwipedLeft: () => setSwipedItem(index),
        onSwipedRight: () => setSwipedItem(index),
        onSwiped: () => setSwipedItem((prev) => (prev === index ? null : index)),
                    ...
                    <React.Fragment key={stock.id}>
                        <Box
                            ...
                            sx={{
                                ...
                                // position: 'relative',
                                px: 0.2,
                                transform: swipedItem === idx ? 'translateX(-100px)' : 'translateX(0)',
                        ...
                        >
                            ...
                            {swipedItem === idx && (
                                <Button
                                    ...
                                    onClick={() => alert(`Button clicked for ${item}`)}
                                >
                                    Action
                                </Button>
                            )}
...
export default MobileStockWithReactSwipeable;
